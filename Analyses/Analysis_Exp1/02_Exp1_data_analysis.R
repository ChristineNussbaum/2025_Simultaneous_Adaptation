...
# Blockorder            #Order of Blocks: 1 = first female-angry and male-fearful, then male-angry and female-fearful, 2 = vice versa
# Stimulus              #presented stimulus
...
# 4 AdaptType:SpSex F(1, 38) = 106.858, p < .001, np2 = .738 -> replicates the GLMM, not reported in the manuscript
#############################################################################
