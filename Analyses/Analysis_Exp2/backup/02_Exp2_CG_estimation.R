##########################################################################
## File: 02_Exp2_CG_estimation.R
## Data CG estimation for Exp 2: Adaptation of Emotion - speaker identities
...
CG_input <- mySummary(E2_Adapt, Resp, Participant, AdaptType, SpID, SpSex, tML) # Input for each participant, Adaptation Blocks
CG_input_BL <- mySummary(E2_Bline, Resp, Participant, Block, SpSex, SpID, tML) # Input for each participant, Baseline Blocks
...
#save the datasets
save(CGagg, CGdata, CG_input, CG_agg_input, badFit, file="input/Exp2_CG_estimates.RData")
