...
# Blockorder            #Order of Blocks: 1 = first w01/w02-angry and w03/w04-fearful, then w03/w04-angry and w01/w02-fearful, 2 = vice versa
# Stimulus              #presented stimulus
...
#Note: the model gives me 14 divergent transitions after warmup. 
...
# therefore, I decided to accept the model as is. 14/1000 is less than 0.5%
...
#now lets calculate the bayes factor
BF <-bayes_factor(fullmodel, redmodel)
#0.06824 -> this value can vary a little in each run, as it seems. But it is always <.10
