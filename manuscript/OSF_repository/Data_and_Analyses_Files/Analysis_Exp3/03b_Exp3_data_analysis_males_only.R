##########################################################################
## File: 03b_Exp3_data_analysis_males_only.R
## Data Analysis for Exp 3: Adaptation of Emotion - pseudowords, male speakers only
# male voices only
...
############
#Full Model
#note: due to convergence problems, therefore I estimated a much simpler Model
...
#Note: the model gives me 85 divergent transitions after warmup. 
...
#79 divergent transitions
#also not ideal, but thats acceptable as well

BF <-bayes_factor(fullmodel, redmodel)

#BF is 0.19, which indicated moderate evidence for the Null Hypothesis (<0.33)
